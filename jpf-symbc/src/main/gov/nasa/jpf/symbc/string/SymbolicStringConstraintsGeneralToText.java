...
public class SymbolicStringConstraintsGeneralToText {
	...
	public boolean isSatisfiable(StringPathCondition pc) {
		...
		/*
		 * Convert each clause in the path condition to a subgraph, and add it
		 * to the global_graph
		 */
		if (sc != null) {
	...
	private void processIntegerConstraint(Expression e) {
		...
		if (e instanceof SymbolicCharAtInteger) {
			...
			global_graph.addEdge(v2, v1, new EdgeCharAt("CharAt_" + scai.index.solution() + "_" + scai.solution(), v2,
					v1, scai.index, scai));
