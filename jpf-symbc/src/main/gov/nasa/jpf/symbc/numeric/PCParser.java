...
public class PCParser {
	...
	static public Map<SymbolicReal, Object> symRealVar; // a map between
														// symbolic real
														// variables and DP
														// variables
	static Map<SymbolicInteger, Object> symIntegerVar; // a map between symbolic
														// variables and DP
														// variables
	...
	static Object getExpression(IntegerExpression eRef) {
		...
		if (eRef instanceof SymbolicInteger) {
			...
			if (dp_var == null) {
				dp_var = pb.makeIntVar(((SymbolicInteger) eRef).getName(), ((SymbolicInteger) eRef).getMin(),
						((SymbolicInteger) eRef).getMax());
		...
		case PLUS:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.plus(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.plus(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else
		...
		case MINUS:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.minus(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.minus(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else
		...
		case MUL:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.mult(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.mult(((IntegerConstant) e_rightRef).getValue(), getExpression(e_leftRef));
			else {
				if (pb instanceof ProblemCoral || pb instanceof ProblemZ3 || pb instanceof ProblemZ3BitVector
						|| pb instanceof ProblemZ3Incremental || pb instanceof ProblemZ3BitVectorIncremental)
		...
		case DIV:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				throw new RuntimeException("## Error: this is not a symbolic expression"); //
															...
															// not be linear
				return pb.div(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.div(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else {
				if (pb instanceof ProblemCoral || pb instanceof ProblemZ3 || pb instanceof ProblemZ3BitVector
						|| pb instanceof ProblemZ3Incremental || pb instanceof ProblemZ3BitVectorIncremental)
		...
		case REM:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				throw new RuntimeException("## Error: this is not a symbolic expression"); //
															...
															// not be linear
				return pb.rem(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.rem(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else {
				if (pb instanceof ProblemCoral || pb instanceof ProblemZ3 || pb instanceof ProblemZ3BitVector
						|| pb instanceof ProblemZ3Incremental || pb instanceof ProblemZ3BitVectorIncremental)
		...
		case AND:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.and(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.and(((IntegerConstant) e_rightRef).getValue(), getExpression(e_leftRef));
			else
		...
		case OR:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.or(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.or(((IntegerConstant) e_rightRef).getValue(), getExpression(e_leftRef));
			else
		...
		case XOR:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.xor(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.xor(((IntegerConstant) e_rightRef).getValue(), getExpression(e_leftRef));
			else
		...
		case SHIFTR:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.shiftR(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.shiftR(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else
		...
		case SHIFTUR:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.shiftUR(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.shiftUR(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else
		...
		case SHIFTL:
			if (e_leftRef instanceof IntegerConstant && e_rightRef instanceof IntegerConstant)
				...
				return pb.shiftL(((IntegerConstant) e_leftRef).getValue(), getExpression(e_rightRef));
			else if (e_rightRef instanceof IntegerConstant)
				return pb.shiftL(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).getValue());
			else
	...
	static Object getExpression(RealExpression eRef) {
		...
		if (eRef instanceof SymbolicReal) {
			...
			if (dp_var == null) {
				dp_var = pb.makeRealVar(((SymbolicReal) eRef).getName(), ((SymbolicReal) eRef).getMin(),
						((SymbolicReal) eRef).getMax());
		...
		if (eRef instanceof BinaryRealExpression) {
			...
			opRef = ((BinaryRealExpression) eRef).getOperator();
			...
			case PLUS:
				if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant)
					return pb.constant(((RealConstant) e_leftRef).getValue() + ((RealConstant) e_rightRef).getValue());
				// throw new RuntimeException("## Error: this is not a symbolic
				// expression"); //
				else if (e_leftRef instanceof RealConstant)
					return pb.plus(((RealConstant) e_leftRef).getValue(), getExpression(e_rightRef));
				else if (e_rightRef instanceof RealConstant)
					return pb.plus(getExpression(e_leftRef), ((RealConstant) e_rightRef).getValue());
				else
					return pb.plus(getExpression(e_leftRef), getExpression(e_rightRef));
			case MINUS:
				if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant)
					...
					return pb.minus(((RealConstant) e_leftRef).getValue(), getExpression(e_rightRef));
				else if (e_rightRef instanceof RealConstant)
					return pb.minus(getExpression(e_leftRef), ((RealConstant) e_rightRef).getValue());
				else
					return pb.minus(getExpression(e_leftRef), getExpression(e_rightRef));
			case MUL:
				if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant)
					...
					return pb.mult(((RealConstant) e_leftRef).getValue(), getExpression(e_rightRef));
				else if (e_rightRef instanceof RealConstant)
					return pb.mult(((RealConstant) e_rightRef).getValue(), getExpression(e_leftRef));
				else
					return pb.mult(getExpression(e_leftRef), getExpression(e_rightRef));
			case DIV:
				if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant)
					...
					return pb.div(((RealConstant) e_leftRef).getValue(), getExpression(e_rightRef));
				else if (e_rightRef instanceof RealConstant)
					return pb.div(getExpression(e_leftRef), ((RealConstant) e_rightRef).getValue());
				else
					return pb.div(getExpression(e_leftRef), getExpression(e_rightRef));
			case AND:
				if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant)
					...
					return pb.and(((RealConstant) e_leftRef).getValue(), getExpression(e_rightRef));
				else if (e_rightRef instanceof RealConstant)
					return pb.and(((RealConstant) e_rightRef).getValue(), getExpression(e_leftRef));
				else
					return pb.and(getExpression(e_leftRef), getExpression(e_rightRef));
		...
		if (eRef instanceof MathRealExpression) {
			...
			case POW:
				if (e_arg2Ref instanceof RealConstant)
					return pb.power(getExpression(e_arg1Ref), ((RealConstant) e_arg2Ref).getValue());
				else if (e_arg1Ref instanceof RealConstant)
					return pb.power(((RealConstant) e_arg1Ref).getValue(), getExpression(e_arg2Ref));
				else
					return pb.power(getExpression(e_arg1Ref), getExpression(e_arg2Ref));
			case ATAN2:
				if (e_arg2Ref instanceof RealConstant)
					return pb.atan2(getExpression(e_arg1Ref), ((RealConstant) e_arg2Ref).getValue());
				else if (e_arg1Ref instanceof RealConstant)
					return pb.atan2(((RealConstant) e_arg1Ref).getValue(), getExpression(e_arg2Ref));
				else
	...
	static public boolean createDPMixedConstraint(MixedConstraint cRef) { // TODO
		...
		if (c_leftRef instanceof SymbolicReal && c_rightRef instanceof SymbolicInteger) {
			...
			Object tmpi = pb.makeIntVar(c_rightRef + "_" + c_rightRef.hashCode(),
					(int) (((SymbolicReal) c_leftRef).getMin()), (int) (((SymbolicReal) c_leftRef).getMax()));
			if (c_rightRef instanceof IntegerConstant)
				pb.post(pb.eq(((IntegerConstant) c_rightRef).getValue(), tmpi));
			else
			...
			pb.post(pb.mixed(getExpression(c_leftRef), tmpi));
															...
															// RealExpression
			Object tmpr = pb.makeRealVar(c_leftRef + "_" + c_leftRef.hashCode(), ((SymbolicInteger) c_rightRef).getMin(),
					((SymbolicInteger) c_rightRef).getMax());
			if (c_leftRef instanceof RealConstant)
				pb.post(pb.eq(tmpr, ((RealConstant) c_leftRef).getValue()));
			else
	...
	static public boolean createDPRealConstraint(RealConstraint cRef) {
		...
		case EQ:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				if (!(((RealConstant) c_leftRef).getValue() == ((RealConstant) c_rightRef).getValue()))
					return false;
				else
					return true;
			} else if (c_leftRef instanceof RealConstant) {
				pb.post(pb.eq(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.eq(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		case NE:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				...
				pb.post(pb.neq(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.neq(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		case LT:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				...
				pb.post(pb.lt(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.lt(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		case GE:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				...
				pb.post(pb.geq(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.geq(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		case LE:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				...
				pb.post(pb.leq(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.leq(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		case GT:
			if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
				...
				pb.post(pb.gt(((RealConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof RealConstant) {
				pb.post(pb.gt(getExpression(c_leftRef), ((RealConstant) c_rightRef).getValue()));
			} else
		...
		for (LinearIntegerConstraint cRef : c.getList()) {
			...
			case EQ:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					if (((IntegerConstant) c_leftRef).getValue() == ((IntegerConstant) c_rightRef).getValue())
						return true;
					...
					Object cc = pb.eq(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.eq(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
			...
			case NE:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					...
					tempVars++;
					pb.post(pb.eq(tempVar, part1));
					Object cc = pb.neq(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
				} else if (c_rightRef instanceof IntegerConstant) {
					Object part1 = getExpression(c_leftRef);
					Object tempVar = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.neq(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
					Object part2 = getExpression(c_rightRef);
					Object tempVar1 = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
			...
			case LT:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					...
					tempVars++;
					pb.post(pb.eq(tempVar, part1));
					Object cc = pb.lt(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
				} else if (c_rightRef instanceof IntegerConstant) {
					Object part1 = getExpression(c_leftRef);
					Object tempVar = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.lt(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
					Object part2 = getExpression(c_rightRef);
					Object tempVar1 = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
			...
			case GE:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					...
					tempVars++;
					pb.post(pb.eq(tempVar, part1));
					Object cc = pb.geq(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
				} else if (c_rightRef instanceof IntegerConstant) {
					Object part1 = getExpression(c_leftRef);
					Object tempVar = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.geq(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
					Object part2 = getExpression(c_rightRef);
					Object tempVar1 = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
			...
			case LE:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					...
					tempVars++;
					pb.post(pb.eq(tempVar, part1));
					Object cc = pb.leq(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
				} else if (c_rightRef instanceof IntegerConstant) {
					Object part1 = getExpression(c_leftRef);
					Object tempVar = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.leq(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
					Object part2 = getExpression(c_rightRef);
					Object tempVar1 = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
			...
			case GT:
				if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
					...
					tempVars++;
					pb.post(pb.eq(tempVar, part1));
					Object cc = pb.gt(((IntegerConstant) c_leftRef).getValue(), tempVar);
					orList.add(cc);
				} else if (c_rightRef instanceof IntegerConstant) {
					Object part1 = getExpression(c_leftRef);
					Object tempVar = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
					...
					pb.post(pb.eq(tempVar, part1));
					tempVars++;
					orList.add(pb.gt(tempVar, ((IntegerConstant) c_rightRef).getValue()));
				} else {
					Object part1 = getExpression(c_leftRef);
					Object part2 = getExpression(c_rightRef);
					Object tempVar1 = pb.makeIntVar("mytemp" + tempVars, MinMax.getVarMinInt(""),
	...
	static public boolean createDPLinearIntegerConstraint(LinearIntegerConstraint cRef) {
		...
		case EQ:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.eq(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.eq(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.eq(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		case NE:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.neq(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.neq(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.neq(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		case LT:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.lt(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.lt(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.lt(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		case GE:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.geq(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.geq(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.geq(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		case LE:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.leq(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.leq(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.leq(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		case GT:
			if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
				...
				pb.post(pb.gt(((IntegerConstant) c_leftRef).getValue(), getExpression(c_rightRef)));
			} else if (c_rightRef instanceof IntegerConstant) {
				pb.post(pb.gt(getExpression(c_leftRef), ((IntegerConstant) c_rightRef).getValue()));
			} else
				pb.post(pb.gt(getExpression(c_leftRef), getExpression(c_rightRef)));
			break;
		}
	...
	private static boolean addConstraint(Constraint cRef) {
		...
		if (cRef instanceof RealConstraint)
			...
			// throw new RuntimeException ("String solving only works with Choco
			// for now");
			// }
			...
			// System.out.println("## Warning: Non Linear Integer Constraint
			// (only coral or z3 can handle it)" + cRef);
			if (pb instanceof ProblemCoral || pb instanceof ProblemZ3 || pb instanceof ProblemZ3BitVector
					|| pb instanceof ProblemZ3Incremental || pb instanceof ProblemZ3BitVectorIncremental)
